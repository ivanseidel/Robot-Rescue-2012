...
public class RescueB extends RobotActivity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		((Button) findViewById(R.id.runProgram3)).setOnClickListener(new OnClickListener() {
			
			public void onClick(View v) {
				IOIO.disconnected();
				RescueB.this.startActivity(new Intent(RescueB.this, Program3.class));
			}
		});
			...
			handler.post(new Runnable() {
				...
				public void run() {
					try {
						...
						boolean hasvictim = victim.checkVictim();
